...
public class PlayerAI extends Player {
  ...
  protected int[] currentState = new int[] { 0, 0, 0, 0, 0, 0, 0, 0, 0 };
  ...
  */
  ...
  public PlayerAI(BoardReader boardReader, Board.Piece playerID) {
    ...
    System.out.println("Initial board state: " + Arrays.toString(currentState));
    updateBoardState();
  }
  ...
  */
  ...
  private void updateBoardState() {
    ...
    System.out.println("Updated board state: " + Arrays.toString(currentState));
  }
  ...
  private Boolean isValidMove(int pieceToMove) {
    ...
    } else if (empty == CIRCLE_SIZE && (super.boardReader.pieceAt(spaceToRight) == opponentID
        || super.boardReader.pieceAt(spaceToLeft) == opponentID)) {
      // check if you can move the piece to the middle

      //is valid move

    } else if (super.boardReader.pieceAt(spaceToRight) == Board.Piece.BLANK
        || super.boardReader.pieceAt(spaceToLeft) == Board.Piece.BLANK) {
      // side to side
